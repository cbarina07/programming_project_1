...
<body>         
    ...
    <div class="setup-page-wrapper">
        <form class="create-form" action="/" method="POST"><!-- TODO:link to next page (home/settings) tbc -->
            ...
            <div class="create-form-col"> <!-- TODO:Display profile name ( from db) + send new name to db + input validation-->
            ...
            <div class="create-form-col"> <!-- TODO:Display email (from db) +  send new email to db + input validation-->
            ...
            <div class="create-form-col"> <!-- TODO:Display lock icon + Display masked password (from db) +  send new password to db (clarify password policy) + input validation-->
            ...
            <div class="create-form-col"> <!-- TODO:Display location (from db) + update new location to db + get list of avaliable location (?) -->
